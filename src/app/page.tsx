      ...
      <main className="flex-1 relative z-[1]">
        ...
        <section className="py-28 px-8 bg-white relative z-[1]">
          <div className="max-w-6xl mx-auto">
            <FadeIn className="text-center mb-20">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#212121] mb-6 tracking-tight" style={{ fontFamily: "'Source Serif 4', serif", fontWeight: 700 }}>
        ...
        <section className="py-24 px-8 bg-[#f8f9fc] relative z-[1]">
          <FadeIn className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold text-[#212121] mb-6 tracking-tight" style={{ fontFamily: "'Source Serif 4', serif", fontWeight: 700 }}>
        ...
        <section className="py-28 px-8 bg-white relative z-[1]">
          <div className="max-w-3xl mx-auto">
            <FadeIn className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#212121] mb-4 tracking-tight" style={{ fontFamily: "'Source Serif 4', serif", fontWeight: 700 }}>Questions?</h2>
            </FadeIn>
        ...
        >
          ...
          <FadeIn className="max-w-3xl mx-auto text-center relative z-10">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 tracking-tight" style={{ fontFamily: "'Source Serif 4', serif", fontWeight: 700 }}>
