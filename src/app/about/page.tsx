  ...
  return (
    <div className="min-h-screen bg-[#f8f9fc] flex flex-col">
      ...
      <main className="flex-1 px-8 py-16 max-w-3xl mx-auto w-full">
        <h1 className="text-3xl font-bold text-[#212121] mb-4">About WOML</h1>
        ...
        <h2 className="text-xl font-semibold text-[#212121] mt-10 mb-4">Who It&apos;s For</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
          <div className="border border-gray-200 rounded-xl p-6">
            <h3 className="font-semibold text-[#212121] mb-2">Businesses</h3>
          ...
          <div className="border border-gray-200 rounded-xl p-6">
            <h3 className="font-semibold text-[#212121] mb-2">Lead Providers</h3>
            <p className="text-gray-500 text-sm leading-relaxed">
        ...
        <h2 className="text-xl font-semibold text-[#212121] mb-4">Our Mission</h2>
