...
function computeChartData(rawData: SpendingDay[]): ChartPoint[] {
...
export default function BusinessRevenueChart({ spendingByDay }: BusinessRevenueChartProps) {
  const [hoveredIndex, setHoveredIndex] = useState<number | null>(null);

  const chartData = useMemo(() => computeChartData(spendingByDay), [spendingByDay]);
    ...
    <div>
        ...
        {hoveredIndex !== null && hoveredData && (
          ...
          >
            ...
            <p className="text-[#E8822A] text-xs">
              Cost: ${hoveredData.revenue.toFixed(2)}
            </p>
      ...
      <div className="flex items-center gap-5 mt-3 ml-1">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-gray-600 text-xs">Daily Spending</span>
        </div>
        <div className="flex items-center gap-1.5">
