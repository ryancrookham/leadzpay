...
import CriteriaFieldBuilder, { type CriteriaField, fieldTypeBadge } from "./CriteriaFieldBuilder";
...
export default function InviteTab({ businessName, initialTokens, initialCriteria, initialFields, defaultPaymentMode, businessPhone }: InviteTabProps) {
  ...
  // Field management functions moved to shared CriteriaFieldBuilder component
  ...
  // fieldTypeBadge moved to shared CriteriaFieldBuilder component
        ...
        {!savedCriteria && !criteriaEditing ? (
          ...
          <div className="space-y-5">
            ...
            <CriteriaFieldBuilder
              ...
              callPhone={criteriaCallPhone}
              setCallPhone={setCriteriaCallPhone}
            />
